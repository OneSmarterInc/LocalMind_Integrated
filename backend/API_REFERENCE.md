...
Fetch complete message history for a conversation by conversation ID.
...
### `GET /api/tutor/conversations/module/{micro_module_id}/`

Fetch previous doubt conversation history for a specific module directly by `micro_module_id`.

**Response `200 OK`**
```json
{
  "id": "uuid",
  "micro_module_id": "micro-module-uuid",
  "micro_module_title": "Stuxnet (2010)",
  "messages": [
    {
      "id": "uuid",
      "role": "student",
      "content": "What was the initial vector for Stuxnet?",
      "created_at": "2026-08-22T09:05:00Z"
    },
    {
      "id": "uuid",
      "role": "tutor",
      "content": "It spread initially via infected USB flash drives.",
      "created_at": "2026-08-22T09:05:02Z"
    }
  ]
}
```
*(If no conversation exists for the module yet, returns `"id": null` and `"messages": []` with `200 OK`)*
